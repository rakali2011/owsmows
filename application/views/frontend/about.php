        ...
        <div class="row">
            ...
            <div class="column col-xs-12 col-sm-3" id="left_column">
                    ...
                    <div class="block_content">
                        ...
                        <div class="layered layered-category">
                            <div class="layered-content">
                                <ul class="tree-menu">
                                    <li class="active"><span></span><a href="about.html">About Us</a></li>
                                    <li><span></span><a href="about.html">Delivery Information</a></li>
                                    <li><span></span><a href="about.html">Privacy Policy</a></li>
                                    <li><span></span><a href="about.html">Terms &amp; Conditions</a></li>
                ...
                <div class="block left-module">
                    <div class="banner-opacity">
                        <a href="category.html"><img src="<?php echo base_url();?>assets/data/slide-left.jpg" alt="ads-banner"></a>
                    </div>
                </div>
                <!-- ./Banner silebar -->
            </div>
            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                <div class="content-text clearfix">
                    ...
                    <p>Integer rutrum ante eu lacus.Vestibulum libero nisl, porta vel, scelerisque eget, <a href="detail3.html">malesuada at</a>, neque. Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean nec eros. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Suspendisse sollicitudin velit sed leo. Ut pharetra augue nec augue. </p>
